...
const UserCurrency = ({userCurrency, availableCurrencies, changeUserCurrency}) => {
  ...
  const labelComponent = <div className='user-currency-label'>
    {userCurrency.label}
    <svg className='user-currency-triangle-svg' viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path className="user-currency-triangle" d="M5 6h10l-5 9-5-9z"></path></svg>
  </div>
  return(
